                    ...
                    <v-layout row wrap flat class="mb-1">
                        ...
                        <v-flex xs10 sm9 md8 class="pa-2 pl-6">
                            ...
                            <h5  class="px-2 mx-1 grey--text">
                                <span> Searched book and this book are </span>
                                <v-chip small class="primary"> {{finLoc[index]}} %</v-chip>
                                <span>  similar </span>
    ...
    export default {
        ...
        methods: {
            ...
            fetchResults(){
                ...
                // CHANGE BELOW FOR GLOBAL EXPLANATIONS
                ...
                // CHANGE BELOW FOR LOCAL EXPLANATIONS
